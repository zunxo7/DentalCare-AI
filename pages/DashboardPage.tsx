...
import { TotalMessagesIcon, UniqueUsersIcon, TotalFaqsIcon, TimeIcon, SpinnerIcon, TrashIcon } from '../components/icons';
...
const DashboardPage: React.FC<DashboardPageProps> = ({ faqs, stats, loading, refreshData, showToast }) => {
    ...
    useEffect(() => {
        // Refresh data immediately on component mount
        refreshData();
        
        // Set up an interval to refresh data every 5 seconds to simulate live data
        const intervalId = setInterval(() => refreshData(true), 5000);
